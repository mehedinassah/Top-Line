    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="name" className="block text-base sm:text-sm font-medium text-neutral-900">
              Full Name
            </label>
            <input
              id="name"
              ...
              placeholder="Mandi Hassan"
              className="mt-1 w-full border border-neutral-300 bg-white px-4 py-3 sm:py-2.5 text-base sm:text-sm placeholder-neutral-500 outline-none transition focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900"
              disabled={isLoading}
            />
          </div>

          <div>
            <label htmlFor="email" className="block text-base sm:text-sm font-medium text-neutral-900">
              Email Address
            </label>
            <input
              id="email"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-base sm:text-sm font-medium text-neutral-900">
              Confirm Password
            </label>
          ...
          <label className="flex items-start gap-3">
            <input
              ...
              disabled={isLoading}
            />
            <span className="text-sm sm:text-xs text-neutral-700">
              I agree to the{" "}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded bg-neutral-900 px-6 py-3 sm:py-2.5 font-semibold text-base sm:text-sm text-white transition hover:bg-neutral-800 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isLoading ? "Creating account..." : "Create Account"}
          </button>
        </form>

          <p className="mt-6 text-center text-base sm:text-sm text-neutral-700">
