...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-neutral-900">
      ...
      >
        <div className="max-w-4xl px-4 sm:px-6 text-center space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-4 sm:pt-6">
            <Link
              href="/products"
              className="bg-white px-6 sm:px-8 py-2.5 sm:py-3 text-center text-xs sm:text-sm font-semibold text-neutral-900 hover:bg-neutral-100 transition duration-200 shadow-lg"
            ...
            <Link
              ...
              className="border-2 border-white px-6 sm:px-8 py-2.5 sm:py-3 text-center text-xs sm:text-sm font-semibold text-white hover:bg-white/10 transition duration-200"
      ...
      >
        <ChevronLeftIcon className="h-5 sm:h-6 w-5 sm:w-6" />
      </button>
      ...
      <button
        ...
        title="Next image"
      >
        <ChevronRightIcon className="h-5 sm:h-6 w-5 sm:w-6" />
      </button>
