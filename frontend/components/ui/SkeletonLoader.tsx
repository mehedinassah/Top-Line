...
export function ProductCardSkeleton() {
  return (
    <div className="group flex h-full flex-col rounded-2xl border border-neutral-200 bg-white p-3 animate-pulse">
      ...
      <div className="mt-3 flex flex-grow flex-col gap-2 md:gap-3">
        ...
        <div className="mt-4 space-y-2">
          <div className="flex gap-1">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-4 w-4 bg-neutral-200 rounded" />
            ))}
          </div>
