      ...
      <section className="border-b border-neutral-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-8 md:py-12">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-neutral-900 md:text-4xl">Men's Collection</h1>
            <p className="text-neutral-600">Premium essentials and timeless pieces for the modern wardrobe</p>
          </div>
        </div>
      </section>
