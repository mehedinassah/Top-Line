  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          backgroundImage: "linear-gradient(135deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 100%), url('https://images.unsplash.com/photo-1542272604-787c62d465d1?w=2000&h=600&fit=crop&q=80')",
